        ...
        <div class="col-md-12">
            <div class="card">
                ...
                <div class="card-body">
                    ...
                    <form action="<?php echo Uri::create('admin/user/edit/' . $user['id']); ?>" method="POST">
                            ...
                            <div class="col-md-6">
                                <div class="mb-3">
                                    ...
                                    <input type="text" 
                                           ...
                                           value="<?php echo Input::post('username', $user['username']); ?>"
                                           required />
                            ...
                            <div class="col-md-6">
                                <div class="mb-3">
                                    ...
                                    <input type="email" 
                                           ...
                                           value="<?php echo Input::post('email', $user['email']); ?>"
                                           required />
                            ...
                            <div class="col-md-6">
                                <div class="mb-3">
                                    ...
                                    <input type="text" 
                                           ...
                                           value="<?php echo Input::post('name', $user['name']); ?>"
                                           required />
                            ...
                            <div class="col-md-6">
                                <div class="mb-3">
                                    ...
                                    <input type="text" 
                                           ...
                                           value="<?php echo Input::post('phone', $user['phone']); ?>" />
                            ...
                            <div class="col-md-6">
                                <div class="mb-3">
                                    ...
                                    <select name="group" id="group" class="form-control" required>
                                        ...
                                        <option value="<?= $value ?>" <?= (Input::post('group', $user['group']) == $value) ? 'selected' : '' ?>>
                                            <?= e($label) ?>
                                        </option>
                                        <?php endforeach; ?>
                                    </select>
                        ...
                        <div class="mb-3">
                            ...
                            <div class="form-check form-check-inline">
                                <input type="radio" 
                                       ...
                                       value="0"
                                       <?php echo (Input::post('gender', $user['gender']) == 0) ? 'checked' : ''; ?> />
                            ...
                            <div class="form-check form-check-inline">
                                <input type="radio" 
                                       ...
                                       class="form-check-input" 
                                       value="1"
                                       <?php echo (Input::post('gender', $user['gender']) == 1) ? 'checked' : ''; ?> />
