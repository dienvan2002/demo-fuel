...
<div class="admin-menu">
      <div class="menu-block">
            ...
            <ul>
                  ...
                  <li>
                        <a class="link <?= ($current_controller == 'product') ? 'active' : '' ?>"
                              href="<?php echo Uri::create('admin/product'); ?>">
                              Quản lý sản phẩm
                        </a>
                  </li>
                  <li>
                        <a class="link <?= ($current_controller == 'category') ? 'active' : '' ?>"
                              href="<?php echo Uri::create('admin/category'); ?>">
                              Quản lý danh mục sản phẩm
                        </a>
                  </li>
                  <li>
                        <a class="link <?= ($current_controller == 'user') ? 'active' : '' ?>"
                              href="<?php echo Uri::create('admin/user'); ?>">
                              Quản lý người dùng
                        </a>
                  </li>
            </ul>
